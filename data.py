...
# To ensure the fields order in the csvs matches the column order in the sql table schema
...
def audit(osmfile):
    """
        returns a dictionary that match the above function conditions
    """
...
if __name__ == '__main__':
    # Since validaton is slow, considering small sample of map tfor the project is a good bet.
